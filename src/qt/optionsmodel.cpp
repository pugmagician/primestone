...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nPrivateSendAmount")) {
        ...
        if (!settings.contains("nAnonymizePrimeStoneAmount"))
            ...
            settings.setValue("nPrivateSendAmount", settings.value("nAnonymizePrimeStoneAmount").toInt());
    }
    ...
    if (!settings.contains("addrProxy"))
        settings.setValue("addrProxy", "127.0.0.1:31995");
    ...
    if (!settings.contains("addrSeparateProxyTor"))
        settings.setValue("addrSeparateProxyTor", "127.0.0.1:31995");
