    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PrimeStone-light"), QVariant("light"));
    ui->theme->addItem(QString("PrimeStone-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("PrimeStone-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PrimeStone-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PrimeStone-traditional"), QVariant("trad"));
...
QValidator::State ProxyAddressValidator::validate(QString &input, int &pos) const
{
    Q_UNUSED(pos);
    // Validate the proxy
    CService serv(LookupNumeric(input.toStdString().c_str(), 31995));
