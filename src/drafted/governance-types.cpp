...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PrimeStoneNetwork") type = PrimeStoneNetwork;
    if(strType == "PrimeStoneNetworkVariable") type = PrimeStoneNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PrimeStoneNetwork) s = "PrimeStoneNetwork";
    if(type == PrimeStoneNetworkVariable) s = "PrimeStoneNetworkVariable";
