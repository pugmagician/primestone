...
const char * const BITCOIN_CONF_FILENAME = "primestone.conf";
const char * const BITCOIN_PID_FILENAME = "primestoned.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\PrimeStoneCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\PrimeStoneCore
    // Mac: ~/Library/Application Support/PrimeStoneCore
    // Unix: ~/.primestonecore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PrimeStoneCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/PrimeStoneCore";
#else
    // Unix
    return pathRet / ".primestonecore";
#endif
#endif
}
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty primestone.conf if it does not excist
