...
This mechanism has been integrated into Bitcore-Node-PrimeStone which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/primestonepay/insight-api-primestone#web-socket-api](https://github.com/primestonepay/insight-api-primestone#web-socket-api)
* API: [https://github.com/primestonepay/insight-api-primestone#instantsend-transactions](https://github.com/primestonepay/insight-api-primestone#instantsend-transactions)
...
By default, the PrimeStone daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PrimeStone daemon:
