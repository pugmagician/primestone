...
PrimeStone is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 19941.
...
However, in open source software such as PrimeStone, where everyone uses
...
pay attention to for reviewers of PrimeStone code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: PrimeStone uses tinyformat, which is type safe. Leave them out to avoid confusion
